...
class ERPEndpoints(http.Controller):
    ...
    @http.route(['/employee-info'], type='http', auth='user', csrf=False)
    def EmployeeData(self, **kwargs):
        ...
        domain = [('active', 'in', [True, False])] # gives you all records
        if staff_number:
            domain = domain + [
        ...
        if employees:
            for emp in employees:
                responseData = {
                    ...
                    'employee_date': datetime.strftime(emp.first_contract_date, '%d/%m/%Y'),
                    'erp_create_date': datetime.strftime(emp.create_date, '%d/%m/%Y'),
                    'first_name': emp.first_name,
                    'middle_name': emp.middle_name,
                    'department_id': emp.department_id.id,
                    'department_name': emp.department_id.name,
                    'district_id': emp.district_id.id,
                    'district_name': emp.district_id.name,
                    'manager_id': emp.manager_id.id,
                    'manager_name': emp.manager_id.name,
    ...
    @http.route(['/employee-leave-info'], type='http', auth='user', csrf=False)
        ...
        if leaves:
            for emp in leaves:
                responseData = {
                    'company_id': emp.company_id.id,
                    'company_name': emp.company_id.name,
                    'full_name': emp.employee_id.full_name.name,
                    ...
                    'employee_date': datetime.strftime(emp.employee_id.first_contract_date, '%d/%m/%Y'),
                    'erp_create_date': datetime.strftime(emp.employee_id.create_date, '%d/%m/%Y'),
                    'department_id': emp.department_id.id,
                    'department_name': emp.department_id.name,
                    'district_id': emp.district_id.id,
                    'district_name': emp.district_id.name,
