...
class Applicant(models.Model):
    ...
    def action_audit_certify(self):
        if self.stage_id and self.stage_id.group_ids:
            ...
            # raise ValidationError(f'{[user_group_ids]} and {[group_ids_to_check]}')
            ...
            if self.audited == False:
                self.audited = True
            elif self.audited == True:
                self.audited = False
        else:
            raise ValidationError(f"Set the approval groups")
